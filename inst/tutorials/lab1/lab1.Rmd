---
title: "Lab 1: Using Simulations to Check Theory"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
If you are unfamiliar with RMarkdown documents, watch the intro video [here](https://rmarkdown.rstudio.com/lesson-1.html) and browse the associated [cheatsheet](https://github.com/rstudio/cheatsheets/raw/master/rmarkdown-2.0.pdf). We will be working in RMarkdown documents in future labs.
