...
2. Create a new RMarkdown document. Give it the title "Lab0 - Read Data" and add your name as author. You should have a template.Rmd in your project. Open it, copy and paste it into a new Rmd file and proceed (in the top left corner, there is a button with a white square and a green plus sign icon, then choose the RMarkdown option).


3. Download the csv file associated with this lab from Moodle and put it in the same folder as your lab Rmd file. To get these files onto your cloud space, look in the "Files" pane in the bottom right. Click the "Upload" button.
...
5. When you are finished editing your R Markdown document click the "Knit" button and choose "Knit to HTML" in the top left corner of RStudio. This will run all of your code and create a formatted document of the output. If you get an error, it means something in your R Markdown file isn't right, either an error in code or some error in formatting. Note R will look for the data in the same place where the Rmd file lives. 

**Deliverables** 

1. Make sure you have submitted the Google Form above.
2. Submit the Rmd and html files to Moodle. Name them as follows:

LastName-LastName-LastName-L-00.Rmd  (add a third last name if applicable)

LastName-LastName-LastName-L-00.html
...
*Due*: Monday, September 6th at 5 PM
