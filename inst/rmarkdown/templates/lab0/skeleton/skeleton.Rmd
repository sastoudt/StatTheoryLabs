...
We will *not* be using the templates that the video references. Instead, we will start from scratch. In RStudio, go to New File -> R Markdown. Often, I will give you a template that you can add to. Be sure to add your name to the author heading.
...
**Task**: Use the help function to learn about the `rexp` function. Generate 2 random values from an exponential distribution with mean 2. Pay special attention to the parameterization. 
