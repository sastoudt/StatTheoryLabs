...
**Opportunity for Extra Credit:** Complete the Dolphin Activity from 216. If you are interested in this, see me for the printout and props on Wednesday. I need the yellow/white cards back when you turn this in, so don't write on them or lose them. You can either turn in the worksheet (and props) in class on Friday or scan in the worksheet to Moodle by 5 PM on Friday and bring the props to class on Monday. 
