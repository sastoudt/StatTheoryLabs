...
Put the code for your `all_scenarios`, `sim_study_output`, and yourfor loop over all the scenarios here.
...
We ultimately want both tests' results on the same plot instead of two separate ones. To do this, you need to reformat your data. See `pivot_wider` and/or `pivot_longer` (see [here](https://github.com/rstudio/cheatsheets/raw/master/tidyr.pdf) for more details)
